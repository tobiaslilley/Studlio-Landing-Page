<?php
// Get protocol ID from URL parameter
$protocolId = $_GET['id'] ?? null;

if (!$protocolId) {
    // Redirect to protocols page if no ID provided
    header('Location: protocols.html');
    exit;
}

// Supabase configuration
$supabaseUrl = 'https://htizxlmrzfehvpupvwbn.supabase.co';
$supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh0aXp4bG1yemZlaHZwdXB2d2JuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYxMTY3NDEsImV4cCI6MjA3MTY5Mjc0MX0.pBC8d5zXG6DZeU3atMZEqOgY4WG8Mh7T0m2tVk5CcUY';

// Fetch protocol data from Supabase
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $supabaseUrl . '/rest/v1/protocols?id=eq.' . $protocolId);
...
if ($httpCode === 200 && $response) {
    $protocols = json_decode($response, true);
    if (!empty($protocols)) {
...
// Set default values
$protocolName = 'Protocol Details';
$protocolDescription = 'Detailed view of health protocol in STUDL.IO';
$protocolUrl = 'https://studl.io/protocol.php?id=' . $protocolId;

if ($protocol) {
    $protocolName = htmlspecialchars($protocol['name'] ?? 'Protocol Details');
    $protocolDescription = htmlspecialchars($protocol['description'] ?? 'Learn about this health optimization protocol.');
    
    // Truncate description if too long
    if (strlen($protocolDescription) > 150) {
        $protocolDescription = substr($protocolDescription, 0, 147) . '...';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo $protocolName; ?> - STUDL.IO</title>
    <meta name="description" content="<?php echo $protocolDescription; ?>">
    
    <!-- OpenGraph Meta Tags -->
    <meta property="og:title" content="<?php echo $protocolName; ?> - STUDL.IO">
    <meta property="og:description" content="<?php echo $protocolDescription; ?>">
    <meta property="og:image" content="https://studl.io/Assets/opengraph.png">
    <meta property="og:url" content="<?php echo $protocolUrl; ?>">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="STUDL.IO">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $protocolName; ?> - STUDL.IO">
    <meta name="twitter:description" content="<?php echo $protocolDescription; ?>">
                ...
                <div class="protocol-detail-card ${protocol.featured ? 'featured-protocol' : ''}">
                    ...
                    <div class="protocol-detail-content-inner">
                        <div class="protocol-detail-description">
                            ...
                            ${protocol.default_value && protocol.unit && protocol.unit !== '—' ? `
